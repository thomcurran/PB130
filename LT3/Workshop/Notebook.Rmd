...
1. Calcualte the parameters and test for mediation using indirect effects

2. Test interactions with continuous and categorical moderators

3. Plot interactions with continuous and categorical moderators
...
```{r}
mod.model2 <- lm(Exhaustion ~ 1 + Control + dummy + Control*dummy, data=employee)
summary(mod.model2)
```
