...
mean_score <- c(mean(bigfive$neuroticism), mean(bigfive$openness), mean(bigfive$extraversion), mean(bigfive$conscientiousness), mean(bigfive$agreeableness))
personality <- c("neuroticism", "openness", "extraversion", "conscientiousness", "agreeableness")
