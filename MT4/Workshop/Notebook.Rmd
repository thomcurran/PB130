...
install.packages("~/PB130_0.1.0.tar.gz", repos = NULL, type = "source")
...
While we are manipulaitng the data, lets also calculate our wellbeing variable as the average of V10 and V10 and add it to the dataframe. I've left the mutate function empty for you to fill in.


```{r}
WVSwellbeing <- # into existing dataframe
  WVSwellbeing %>% # from existing dataframe
  mutate() # avergage V10 and V10 and asign the sum to a new variable called wellbeing
