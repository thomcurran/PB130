...
All of which are redundant for our interests. This is common when retrieiving large data sets - they are often messy and require manipulating or cleaning! We want tidy data!
...
```{r eval=FALSE}
WVS_short <- # create new data frame WVS_short
...
You can also practice R using a package called Swirl. The following code installs the package swirl. Remeber to dehash the code so it will run!
