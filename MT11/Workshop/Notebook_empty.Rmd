...
There was a statistically significant difference between Americans who reported that they would not like to have immigrants as neighbors and those who did not: t(137) = 2.08, p < .05.
...
Okay, this table puts the sample mean difference into more perspective. Yes, it is statistically significant but the variance explained is tiny - PRE or R2 = 0.2%! This needs to be borne in mind when drawing conclusions. We have statistically significant difference, but is it practically meaningful? Perhaps not.
