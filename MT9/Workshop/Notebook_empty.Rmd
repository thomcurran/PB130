...
The mean perfectionism in UK group was 4.51 (SD = .19), whereas the mean in North America group was 4.61(SD = .35). A two-samples t-test showed that the difference was statistically significant, t(137) = -1.8764, p < 0.05, d = .33; where, t(137) is shorthand notation for a t-statistic that has 137 degrees of freedom.
